...
# URL 正确，但是树形会有一些变形
tree -I "*.png|*.gif|*.webp|*.pdf" -v -L 3 --ignore-case -H 'https://github.com/opsxin/markdown-notes/blob/master' -T markdown-note | awk 'BEGIN{print "<h4>markdown-note</h4>"} /─/{print} /directories/{print}' > README.md
